...
const StakeLfi: React.FC<StakeProps> = ({}) => {
  const tokenName = "LFI"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.lfi[3])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`LFI Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
